...
int main(int argc, char** argv) {
  ...
  fprintf(out, "K1,K3,C11,C12,C44,L100,T100,L110,T110_1,T110_2,L111,T111\n");
  ...
  for (int i1 = i1_start; i1 < i1_end; i1++) {
    ...
    for (int i3 = 0; i3 < N; i3++) {
      ...
      if (lammps_has_error(lmp)) {
        ...
        fprintf(stderr, "K1=%g K3=%g -> ERRORE LAMMPS: %s\n", k1, k3, errmsg);
      } else {
      ...
      if (!c11 || !c12 || !c44) {
        fprintf(stderr, "K1=%g K3=%g -> mancante: C11=%s C12=%s C44=%s\n", k1,
